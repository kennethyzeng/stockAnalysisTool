...
from single_stock import SingleStock 
...
def data_filled_at_excel_for_each_sock(stocks_list):
    SingleStock.download_data("smci")
    pass
#################
#generate_excel_files_for_stocks(stocks_list)
data_filled_at_excel_for_each_sock(stocks_list)
